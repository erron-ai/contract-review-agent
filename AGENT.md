...
## Objective
Maintain `contract-review-agent` as a reliable, useful, and test-first project aligned with its primary promise:
> Reviews contracts against a playbook, flags deviations, and suggests redlines.
